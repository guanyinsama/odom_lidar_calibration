...
//    std::cout << "A: " << A << ' ' << "g: " << g << std::endl;
  ...
  std::cout << "max_cond_number " << max_cond_number << std::endl;
...
/*!<!--############## 		SECOND STEP: estimate the remaining parameters  		########-->*/
  ...
  res.l[1] = laser_y;
  res.l[2] = laser_th;
  std::cout << "laser_x" << laser_x<<std::endl;
  std::cout << "laser_y" << laser_y << std::endl;
  std::cout << "laser_th" << laser_th << std::endl;
  return 1;
}
